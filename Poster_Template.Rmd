...
**Dataset**: NHANES 2013-2014 (R package `NHANES`). ~9,700 participants.
...
- Typical US distribution: 15% Excellent, 41% Very good, 49% Good, 16% Fair, 4% Poor
...
2. Fullerton, A. S. (2009). Ordered Regression Models: Parallel, Partial, and Non-Parallel Alternatives. Chapman and Hall/CRC.
